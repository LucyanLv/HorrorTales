...
public class SmoothPatrol : MonoBehaviour
{
    ...
    void EnviromentView()
    {
        Collider[] playerInRange = Physics.OverlapSphere(transform.position, viewRadious, playerMask);
        for (int i = 0; i < playerInRange.Length; i++)
        {
            ...
            if (Vector3.Distance(transform.position, player.position)>viewRadious)
            {
                m_PlayerInRange = false;
            }
